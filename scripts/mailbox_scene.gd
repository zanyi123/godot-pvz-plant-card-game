...
func _init_letters() -> void:
	letters = [
		...
		},
		{
			"id": "changelog_v1_2",
			"sender": "开发组",
			"subject": "📢 v1.2 新增 22 位伙伴 + 联机对战",
			"body": "【v1.2 更新内容】\n\n新增功能：\n  · 新增 22 位新伙伴植物卡牌进入家族！\n  · 高级坦克：高坚果参与对战，神力钢地刺护你周全\n  · 二人对战联机模式已上线，邀请身边的朋友一起体验！\n\n修复问题：\n  · 修复卡牌结算回合部分问题\n  · 修复联机模式下血条显示不同步\n  · 修复精力点阵和 Buff 栏视角翻转\n\n感谢您的支持与反馈！",
		},
		{
			"id": "changelog_v1_3",
			"sender": "开发组",
			"subject": "📢 v1.3.0 大师级人机 + 无牌强制结算",
			"body": "【v1.3.0 更新内容】\n\n新增功能：\n  · 新增「大师级人机」对战模式！\n    - 阵营克制计算，出牌更精明\n    - 双卡组合策略，爆发/续航/反制兼备\n    - 防守反击思维，低血量时保守应对\n    - 三回合预测，基于自身血量决策\n    - 卡牌记忆库，记录历史出牌规律\n\n  · 难度选择：普通 / 大师（菜单可切换）\n\n修复问题：\n  · 修复「无牌强制结算」功能失效：双方手牌+牌库耗尽时立即结算胜负\n    现已覆盖 5 个关键流程点（补牌后/结算后/补救成功后等）\n  · 修复克制关系失效：辅助卡 type=主 但 faction=辅 导致主卡识别错误\n    新逻辑优先选 faction 为 法/射/坦 的卡作主卡\n  · 修复 AI 不出牌：无合法组合时强制出最小 cost 卡\n  · 修复伤害计算：辅助卡攻击独立计算，倍率仅作用于自身卡牌攻击力\n\n感谢您的支持与反馈！",
		},
		{
			"id": "changelog_v1_4",
			"sender": "开发组",
			"subject": "📢 v1.4.0 图鉴功能上线",
			"body": "【v1.4.0 更新内容】\n\n新增功能：\n  · 主菜单新增「图鉴」入口，一键查阅全部卡牌！\n  · 动态对接 cards.json，新增卡牌自动同步展示\n  · 120×180 大尺寸卡牌渲染，与实战卡牌 UI 一致\n  · 每行 4 张卡片，棕色木制相框背景\n\n筛选功能：\n  · 全部 / 法 / 射 / 坦 / 辅 / 限制符:有 / 限制符:无\n  · 7 类筛选互斥单选，按卡牌 ID 排序\n  · 右上角实时显示当前筛选结果总数\n\n交互体验：\n  · 右键点击卡牌弹出详情弹窗（属性+技能描述）\n  · ESC 键或返回按钮一键退出图鉴\n\n感谢您的支持与反馈！",
		},
		{
			"id": "welcome",
			"sender": "系统管理员",
